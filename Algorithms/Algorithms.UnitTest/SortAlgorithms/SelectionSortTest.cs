...
namespace Algorithms.UnitTest.SortAlgorithms
{
    ...
    public class SelectionSortTest
    {
        ...
        [TestMethod]
        public void TestSelectionSort_PositiveInteger_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestSelectionSort_PositiveInteger_Sorted2()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestSelectionSort_Integer_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestSelectionSort_PositiveIntegerMoreElement_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestSelectionSort_LowerCaseString_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestSelectionSort_UpperCaseString_Sorted()
        {
            //arrange 
            string[] expected = { "A", "B", "C", "D", "E", "F" };
            string[] testCase = { "C", "F", "A", "D", "B", "E" };
        ...
        [TestMethod]
        public void TestSelectionSort_HybridCaseString_Sorted()
        {
            //arrange 
            string[] expected = { "A", "B", "C", "d", "e", "f" };
            string[] testCase = { "C", "f", "A", "d", "B", "e" };
        ...
        [TestMethod]
        public void TestSelectionSort_HybridCaseString_Sorted2()
        {
            //arrange 
            string[] expected = { "a", "b", "c", "D", "E", "f" };
            string[] testCase = { "c", "f", "a", "D", "b", "E" };
        ...
        [TestMethod]
        public void TestSelectionSort_HybridCaseString_Sorted3()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestSelectionSort_HybridCaseStringOnlyA_Sorted()
        {
            //arrange 
