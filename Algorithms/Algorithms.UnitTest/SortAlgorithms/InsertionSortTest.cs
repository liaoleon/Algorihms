...
namespace Algorithms.UnitTest.SortAlgorithms
{
    ...
    public class InsertionSortTest
    {
        ...
        [TestMethod]
        public void TestInsertionSort_PositiveInteger_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestInsertionSort_PositiveInteger_Sorted2()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestInsertionSort_Integer_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestInsertionSort_PositiveIntegerMoreElement_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestInsertionSort_LowerCaseString_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestInsertionSort_UpperCaseString_Sorted()
        {
            //arrange 
            string[] expected = { "A", "B", "C", "D", "E", "F" };
            string[] testCase = { "C", "F", "A", "D", "B", "E" };
        ...
        [TestMethod]
        public void TestInsertionSort_HybridCaseString_Sorted()
        {
            //arrange 
            string[] expected = { "A", "B", "C", "d", "e", "f" };
            string[] testCase = { "C", "f", "A", "d", "B", "e" };
        ...
        [TestMethod]
        public void TestInsertionSort_HybridCaseString_Sorted2()
        {
            //arrange 
            string[] expected = { "a", "b", "c", "D", "E", "f" };
            string[] testCase = { "c", "f", "a", "D", "b", "E" };
        ...
        [TestMethod]
        public void TestInsertionSort_HybridCaseString_Sorted3()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestInsertionSort_HybridCaseStringOnlyA_Sorted()
        {
            //arrange 
