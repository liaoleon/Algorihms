...
namespace Algorithms.UnitTest.SortAlgorithms
{
    ...
    public class QuickSortTest
    {
        ...
        [TestMethod]
        public void TestQuickSort_PositiveInteger_Sorted_Case1()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestQuickSort_PositiveInteger_Sorted_Case2()
        {
            //arrange 
            int[] expected = { 1, 2, 3, 4, 5, 6 };
        ...
        [TestMethod]
        public void TestQuickSort_PositiveInteger_Sorted2()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestQuickSort_Integer_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestQuickSort_PositiveIntegerMoreElement_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestQuickSort_LowerCaseString_Sorted()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestQuickSort_UpperCaseString_Sorted()
        {
            //arrange 
            string[] expected = { "A", "B", "C", "D", "E", "F" };
            string[] testCase = { "C", "F", "A", "D", "B", "E" };
        ...
        [TestMethod]
        public void TestQuickSort_HybridCaseString_Sorted()
        {
            //arrange 
            string[] expected = { "A", "B", "C", "d", "e", "f" };
            string[] testCase = { "C", "f", "A", "d", "B", "e" };
        ...
        [TestMethod]
        public void TestQuickSort_HybridCaseString_Sorted2()
        {
            //arrange 
            string[] expected = { "a", "b", "c", "D", "E", "f" };
            string[] testCase = { "c", "f", "a", "D", "b", "E" };
        ...
        [TestMethod]
        public void TestQuickSort_HybridCaseString_Sorted3()
        {
            //arrange 
        ...
        [TestMethod]
        public void TestQuickSort_HybridCaseStringOnlyA_Sorted()
        {
            //arrange 
